...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  initDataTable() {
    ...
    this.dtOptions = {
      ...
      ajax: (dtParams: any, callback) => {
        ...
        that.categoryService.categoriesGet(query).subscribe((resp: HttpCollectionResponse) => {
          that.categories = resp.data.docs;
          callback({
  ...
  refreshCategories() {
    ...
    this.categoryService.categoriesGet(query).subscribe((resp: HttpCollectionResponse) => {
      $('.dataTables_processing').hide();
      this.categories = resp.data.docs;
      this.rerender();
    });
  }
    ...
    switch (action) {
      ...
      case 'delete':
        this.confirmDialogService.confirm(
          ...
          if (confirmed) {
            this.categoryService.categoryDelete(id).subscribe((res: HttpBasicResponse) => {
